...
human_all_chr: list[int|str] = list(range(1,23))+['X','Y']
mouse_all_chr: list[int|str] = list(range(1,19))+['X','Y']
...
def download_chr(chr_folder:os.PathLike="data/ref",
    ...
    if species in ['human','homo_sapiens']:
        ...
        print("species should be one of ['human','homo_sapiens','mouse','mus_musculus']")
...
if __name__ == "__main__":
    download_chr_list(["X","Y"],remove_gz=True) #tested works